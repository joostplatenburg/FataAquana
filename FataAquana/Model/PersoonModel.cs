                ...
                try
                {
                    ...
                    using (var readerGO = commandGO.ExecuteReader())
                    {
                        while (readerGO.Read())
                        {
                            ...
                            var idGO = readerGO["ID"]as string;
                ...
                try
                {
                    ...
                    using (var readerAK = commandAK.ExecuteReader())
                    {
                        while (readerAK.Read())
                        {
                            ...
                            var idAK = readerAK["ID"] as string;
